...
public class JpaMealRepository implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        if (meal.isNew()) {
            ...
            mealFromRepository.setDateTime(meal.getDateTime());
            mealFromRepository.setDescription(meal.getDescription());
            mealFromRepository.setCalories(meal.getCalories());
            return em.merge(mealFromRepository);
        }
    }
